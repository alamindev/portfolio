    ...
    <div class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card">
            <div class="card-header d-md-flex d-sm-block justify-content-between text-center align-items-center">
                <h4 class="text-capitalize m-0"><i class="fas fa-chess-board"></i> All Roles</h4>
                @permission("create-roles")
                <a href="{{ route('roles.create') }}" class="btn btn-outline-success waves-effect waves-light"> <i class="fas fa-plus"></i>Add New Role</a>
                @endpermission
            </div>
            <div class="card-body">
